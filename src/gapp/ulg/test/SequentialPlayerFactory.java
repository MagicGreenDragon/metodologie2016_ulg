...
/** Una RandPlayerFactory fabbrica giocatori {@link SequentialPlayer}.
 * @param <P>  tipo del modello dei pezzi */
public class SequentialPlayerFactory<P> implements PlayerFactory<Player<P>,GameRuler<P>> {
    @Override
    public String name() { return "Sequential Player"; }
    ...
    public Player<P> newPlayer(GameFactory<? extends GameRuler<P>> gF, String name)
    {
        ...
        return new SequentialPlayer<>(name);
    }
}
