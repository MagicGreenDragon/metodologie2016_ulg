 ...
 *
 */
public class CamelotFactory implements GameFactory<GameRuler<PieceModel<Species>>>
{
	...
	/** Crea una fabbrica di {@code GameRuler} per giocare a Camelot */
	public CamelotFactory()
	{
    ...
    public GameRuler<PieceModel<Species>> newGame()
    {
    	...
    	return new Camelot(this.getTimeParam(), this.player_names[0], this.player_names[1]);
    }
