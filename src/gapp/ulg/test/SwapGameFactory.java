...
/**
 * Factory di Swap Game.
 * 
 * @author Daniele Giudice
 *
 */
public class SwapGameFactory implements GameFactory<GameRuler<PieceModel<Species>>>
{
	...
	/** Crea una fabbrica di {@code GameRuler} per giocare a Swap Game */
	public SwapGameFactory()
	{
		this.params = Collections.unmodifiableList( Arrays.asList(this.time) );
	}
	
    @Override
    public String name() { return "Swap Game"; }
    ...
    public GameRuler<PieceModel<Species>> newGame()
    {
    	...
    	return new SwapGame(this.getTimeParam(), this.player_names[0], this.player_names[1]);
    }
